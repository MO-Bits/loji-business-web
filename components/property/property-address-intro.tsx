...
export function PropertyAddressIntro() {
  return (
    <Box
      component="main"
      sx={{
        background: "radial-gradient(circle at 85% 5%, color-mix(in srgb, var(--mui-palette-primary-main) 12%, transparent), transparent 34%)",
        minHeight: "100dvh",
        py: { xs: 3, md: 7 },
      }}
    >
      <Container maxWidth="md">
        <Stack spacing={{ xs: 4, md: 6 }}>
          ...
          <Box sx={{ display: "grid", gap: { xs: 4, md: 6 }, gridTemplateColumns: { xs: "1fr", md: "1.1fr .9fr" }, alignItems: "center" }}>
            <Stack spacing={2.5}>
              <Box
                sx={{
                  alignItems: "center",
              ...
              <Typography color="text.secondary" sx={{ fontSize: { xs: "1rem", sm: "1.15rem" }, lineHeight: 1.7, maxWidth: 580 }}>
                Set the exact location guests and your team should use. You can search by place name, street, ward, or move the pin directly on the map.
              </Typography>
              ...
              <Button
                ...
                sx={{ alignSelf: { xs: "stretch", sm: "flex-start" }, minHeight: 54, px: 3.5 }}
              >
                Open location map
              </Button>
            </Stack>

            <Paper variant="outlined" sx={{ p: { xs: 2.5, sm: 3 }, background: "color-mix(in srgb, var(--mui-palette-background-paper) 94%, transparent)" }}>
              <Stack spacing={1}>
