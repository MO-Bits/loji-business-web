...
export type MainDestination = { label: string; path: string; icon: React.ReactNode; activeIcon: React.ReactNode; match: (pathname: string) => boolean };
...
export const managementDestinations: MainDestination[] = [
  { label: "Property", path: "/more/property", icon: <ApartmentOutlinedIcon />, activeIcon: <ApartmentRoundedIcon />, match: (path) => path === "/more/property" },
  { label: "Staff", path: "/more/staff", icon: <GroupsOutlinedIcon />, activeIcon: <GroupsRoundedIcon />, match: (path) => path === "/more/staff" },
];
