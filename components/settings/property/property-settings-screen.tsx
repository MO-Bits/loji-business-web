        ...
        <Stack spacing={2.5}>
          <SettingsSection description={t("Every section opens a focused editor and saves independently.", "Kila sehemu hufungua ukurasa wake na kuhifadhi kivyake.")} title={t("Business configuration", "Mpangilio wa biashara")}>
            <Stack divider={<Divider flexItem />}>
              ...
              <PropertySettingLink description={t("Control whether the property is active and visible to booking flows", "Dhibiti kama biashara inatumika na inaonekana kwenye nafasi")} href={capabilities.changeVisibility ? "/settings/property/visibility" : undefined} icon={<PublicOutlinedIcon />} meta={property.isActive ? t("Active", "Inatumika") : t("Hidden", "Imefichwa")} title={t("Status and visibility", "Hali na mwonekano")} />
            </Stack>
          </SettingsSection>
          ...
          <SettingsSection description={t("A concise summary guests and teammates can trust.", "Muhtasari mfupi ambao wageni na timu wanaweza kuamini.")} title={t("About this property", "Kuhusu biashara hii")}>
            <Box sx={{ p: { xs: 2, sm: 2.5 } }}>
              ...
              {property.amenities.length ? <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.75, mt: 2 }}>{property.amenities.slice(0, 12).map((amenity) => <Chip key={amenity} label={amenity} size="small" variant="outlined" />)}{property.amenities.length > 12 ? <Chip color="primary" label={`+${property.amenities.length - 12}`} size="small" /> : null}</Box> : null}
            </Box>
          </SettingsSection>
        </Stack>
