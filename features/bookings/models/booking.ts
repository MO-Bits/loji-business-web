...
const date = (value: Json | undefined) => parseDatabaseDate(value == null ? null : String(value));
const optionalDate = (value: Json | undefined) => value ? parseDatabaseDate(String(value)) : null;
